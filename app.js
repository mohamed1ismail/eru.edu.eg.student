...
const semestersData = {
  ...
  "3-1": {
    ...
    passedCH: "75.00",
    courses: [
      { code: "ERU-CYS307", name: "Ethical Hacking",            status: "Active", point: "3.70", passFail: "Pass", grade: "A-" },
      { code: "ERU-CYS308", name: "Security Operations (SOC)",  status: "Active", point: "3.30", passFail: "Pass", grade: "B+" },
      { code: "ERU-CYS309", name: "Incident Response",          status: "Active", point: "3.00", passFail: "Pass", grade: "B"  },
      { code: "ERU-CYS313", name: "Cryptography",               status: "Active", point: "2.30", passFail: "Pass", grade: "C+" },
      { code: "ERU-CYS312", name: "Secure Network Design",      status: "Active", point: "3.70", passFail: "Pass", grade: "A-" }
    ]
  },
